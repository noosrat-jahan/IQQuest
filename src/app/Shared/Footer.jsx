...
export const Footer = () => {
  return (
		...
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center items-center space-x-3 lg:justify-start">
				<div className="flex items-center justify-center w-12 h-12 rounded-full ">
					<img src="/quiz.png" alt="" className='w-10' />
				</div>
				<span className="self-center text-2xl font-semibold">IQQuest</span>
			</a>
		</div>
	...
	<div className="py-6 text-sm text-center text-gray-400">© 2025 IQQuest All rights reserved.</div>
</footer>
    </div>
  )
}
